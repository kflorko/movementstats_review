...
data_hmm$state <- as.factor(momentuHMM::viterbi(hmm5_km))
...
meanARS <- hmm4_km$mle$step[1,1]  
sdARS <- hmm4_km$mle$step[2,1]    

meanCR <- hmm4_km$mle$step[1,2]    
sdCR <- hmm4_km$mle$step[2,2]     

meanTR <- hmm4_km$mle$step[1,3]    
sdTR <- hmm4_km$mle$step[2,3]    
...
meanARS <- hmm4_km$mle$angle[1,1]  
sdARS <- hmm4_km$mle$angle[2,1]    

meanCR <- hmm4_km$mle$angle[1,2]    
sdCR <- hmm4_km$mle$angle[2,2]  

meanTR <- hmm4_km$mle$angle[1,3]    
sdTR <- hmm4_km$mle$angle[2,3]  
