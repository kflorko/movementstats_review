...
figS2a <- fishmap +
  geom_polygon(data = nat_trans, aes(x=long,y=lat,group=group), fill = "grey80", color = "white") +
  geom_point(data = p1, aes(x = x_,y = y_), alpha = 0.61, color = "#FCEEAE") +
  geom_path(data = p1, aes(x = x_,y = y_), color = "#FCEEAE") +
  theme_minimal() +
  ggtitle("A)") +
  ylab(" \n \n  ") + xlab("") +
  annotate("segment", x=-Inf, xend=Inf, y=-Inf, yend=-Inf, size = 1) +
...
figS2b <- fishmap +
  geom_polygon(data = nat_trans, aes(x=long,y=lat,group=group), fill = "grey80", color = "white") +
  geom_point(data = p2, aes(x = x_,y = y_), alpha = 0.61, color = "#FCEEAE") +
  geom_path(data = p2, aes(x = x_,y = y_), color = "#FCEEAE") +
  theme_minimal() +
  ggtitle("B)") +
  ylab(" \n \n  ") + xlab("") +
  annotate("segment", x=-Inf, xend=Inf, y=-Inf, yend=-Inf, size = 1) +
