...
```{r define parameters for hmm emission probability}
...
Next we grab the parameters from our refined three-state HMM.

```{r grab parameters for hmm emission probability}
