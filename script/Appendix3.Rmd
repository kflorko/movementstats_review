...
#### 2-states with covariate effects on emission probabilities
...
#### 3-states with covariate effects on transition and emission probabilities
...
#### 3-states with covariate effects on emission probabilities

First we define the formulas.

```{r define models for hmm6 emission probability}
...
Get initial parameter estimates based on hmm4_km.


```{r get initial parameter estimates for hmm6 from hmm3}
Par0_hmm6_km <- getPar0(hmm3_km, DM = DM)
```
