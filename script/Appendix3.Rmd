...
#2. SSF
This is not easily implemented. Previous versions of amt had functions for this (habitat_kernel, movement_kernel, and simulate_ud) as shown in Signer et al. 2019. These methods are detailed in Signer et al. 2017.
```{r}
