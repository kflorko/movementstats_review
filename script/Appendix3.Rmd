...
# plot
line_rsf <- ggplot(res, aes(x = preydiv_x1, y = (log_rss))) +
...
line_ssf1 <- ggplot() +
  ...
  geom_line(data = res, aes(x = preydiv_x1, y = log_rss, color = Speed, group = Speed), size = 1, linetype = 3, color = "black") + 
  geom_ribbon(data = res, aes(ymin=lwr, ymax=upr, x=preydiv_x1, fill = Speed, group = Speed), alpha = 0.3, fill = "black") +
  xlab("Prey diversity") +
  ylab("log-RSS") +
  theme_minimal()
line_ssf1
...
line_ssf2 +
  geom_hline(yintercept = 0, linetype = "dashed", color = "gray") +
  geom_line(data = res, aes(x = preydiv_x1, y = log_rss, color = Speed, group = Speed, linetype = Speed), size = 1) + 
  geom_ribbon(data = res, aes(ymin=lwr, ymax=upr, x=preydiv_x1, fill = Speed, group = Speed), alpha = 0.2) +
