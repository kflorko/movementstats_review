...
distFormula = ~ state1(preydiv) + state2(preydiv) + state3(preydiv)

# RON HELP PLEASE! Hopefully we can use most of the above HMM formatting to just incorporate this formula
