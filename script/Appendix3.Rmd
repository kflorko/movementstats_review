...
# get parameters 
Par0_hmm5_km <- momentuHMM::getPar0(hmm2_km, DM = DM)
...
```{r}
plot(hmm5_km, ask = F, col = colours.states, plotCI = TRUE)
```
...
```{r}
statianary_est <- plotStationary(hmm5_km, col = colours.states, plotCI = TRUE, 
