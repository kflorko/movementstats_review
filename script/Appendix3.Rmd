...
We can see that the data has autocorrelation, and that after sampling every 10th row, the autocorrelation seems to be reduced. We will fit a RSF with a dataset that samples every 10th row, and call it rsf2.
